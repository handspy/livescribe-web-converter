...
LiveScribe.Web.Context.prototype.GetFormFactorType = function () {
    ...
    if (this.IsLinuxDesktop()) { return LiveScribe.Web.ContextFormFactorType.DESKTOP; }
};
...
LiveScribe.Web.Context.prototype.GetPlatformType = function () {
    ...
    if (this.IsLinuxDesktop()) { return LiveScribe.Web.ContextPlatformType.LINUX; }
};
...
LiveScribe.Web.Context.prototype.GetDeviceType = function () {
    ...
    if (this.IsLinuxDesktop()) { return LiveScribe.Web.ContextDeviceType.LINUX; }
};
...
LiveScribe.Web.Context.prototype.IsLinuxDesktop = function () {
    return /Linux/.test(navigator.userAgent) ? true : false;
};
